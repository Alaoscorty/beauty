...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const productData = {
    Huilesatinee: {
      name: "Huile Satinée",
      description:
        "Une huile qui nourrit la peau en profondeur et laisse un fini soyeux.",
      price: "10 000 FCFA",
      image:
        "https://i.pinimg.com/736x/1b/89/2c/1b892c0fdecd59cfc133af80e014318c.jpg",
    },
    Hydratanteintense: {
      name: "Crème Hydratante Intense",
      description:
        "Crème riche conçue pour hydrater intensément les peaux sèches.",
      price: "15000 FCFA",
      image:
        "https://i.pinimg.com/736x/60/0e/54/600e540b2886cb7195511c6d8b1eb7c0.jpg",
    },
    Masqueeclat: {
      name: "Masque Éclat Doré",
      description:
        "Masque illuminant à base d'extraits naturels pour un teint radieux.",
      price: "3000 FCFA",
      image:
        "https://i.pinimg.com/736x/5f/06/bf/5f06bf55271c7489b8a375c8aef2adb9.jpg",
    },
    nettoyant: {
      name: "Nettoyant Doux",
      ...
      price: "5000 FCFA",
      image:
        "https://i.pinimg.com/736x/6f/c0/3e/6fc03ee4ee8f56d73c27a3eda2ae3462.jpg",
    },
    Laitcorps: {
      name: "Lait Corps Nourrissant",
      description:
        "Hydrate et adoucit la peau du corps grâce à une formule enrichie.",
      price: "2500 FCFA",
      image:
        "https://i.pinimg.com/736x/75/97/64/7597645b096ef404252c1fc7d74cbd3b.jpg",
    },
    Gommagesucre: {
      ...
      price: "7500 FCFA",
      image:
        "https://i.pinimg.com/736x/03/35/36/033536ea8eff5c3aa2d7d49d57042c07.jpg",
    },
    Mainreparatrice: {
      ...
      price: "4000 FCFA",
      image:
        "https://i.pinimg.com/736x/1f/5d/41/1f5d414f0b4b118d194eeea0acacdf81.jpg",
    },
    Shampooingfortifiant: {
      ...
      price: "10 000 FCFA",
      image:
        "https://i.pinimg.com/736x/07/fb/0c/07fb0cb4b1c84996252afa3acb04cccd.jpg",
    },
    Masquereparateur: {
      ...
      price: "11 500 FCFA",
      image:
        "https://i.pinimg.com/736x/00/17/09/001709e19d7113a6a83b4532270ea497.jpg",
    },
    Huilecapillaire: {
      ...
      price: "9500 FCFA",
      image:
        "https://i.pinimg.com/736x/2a/45/ad/2a45ad3d16c2c0f042ed60c3510d2c6a.jpg",
    },
    serum: {
      ...
      price: "12 000 FCFA",
      image:
        "https://i.pinimg.com/736x/c8/0b/d9/c80bd9504d441301ae349138a354f4c6.jpg",
    },
    Capillairebrillance: {
      name: "Huile Capillaire Brillance",
      description:
        "Idéale pour sublimer la chevelure avec une brillance naturelle.",
      price: "9500 FCFA",
      image:
        "https://i.pinimg.com/736x/8d/fb/67/8dfb67f324f61bf2ca9335c9f162f107.jpg",
    },
    Frisottis: {
      name: "Sérum Anti-Frisottis",
      ...
      price: "12 000 FCFA",
      image:
        "https://i.pinimg.com/736x/c6/4c/b6/c64cb632db7f82cb6d21e423b5fd7455.jpg",
    },
    Aloevera: {
      ...
      price: "6000 FCFA",
      image:
        "https://i.pinimg.com/736x/c3/b8/e0/c3b8e0d12daf660c1691682482868afc.jpg",
    },
    Jojoba: {
      ...
      price: "7000 FCFA",
      image:
        "https://i.pinimg.com/736x/4b/5b/c9/4b5bc90a26687361c70c2174f1765485.jpg",
    },
    Argileverte: {
      name: "Argile Verte Detox",
      description:
        "Purifie les peaux grasses et mixtes, effet matifiant immédiat.",
      price: "5500 FCFA",
      image:
        "https://i.pinimg.com/736x/b4/b6/bd/b4b6bdd0025e8a17b427664a56be4d9c.jpg",
    },
    Eauderose: {
      ...
      price: "5000 FCFA",
      image:
        "https://i.pinimg.com/736x/78/f7/ec/78f7ecd842617b8f53112d3b5225ca91.jpg",
    },
    hydratante: {
      name: "Crème Hydratante Intense",
      description:
        "Une crème riche qui hydrate en profondeur, parfaite pour les peaux sèches.",
      price: "8000 FCFA",
      image:
        "https://i.pinimg.com/736x/38/c2/78/38c278274026ddd250664a9af7bf2735.jpg",
    },
    masque: {
      name: "Masque Éclat Doré",
      description:
        "Un masque éclat avec des extraits de perle pour illuminer le teint.",
      price: "4000 FCFA",
      image:
        "https://i.pinimg.com/736x/bf/f3/58/bff358931791e7b8acc8f486fc02358e.jpg",
    },
  };
...
document
  .getElementById("whatsapp-reservation-form")
...
if (!searchInput || !searchBtnSubmit || !noResultDiv) {
  console.error(
    "Un ou plusieurs éléments de la barre de recherche sont introuvables dans le DOM."
  );
}

// Liste des produits (noms en minuscules)
const products = ["crème hydratante intense"];
if (searchBtnSubmit) {
